...
dusaeva::CompositeShape::CompositeShape(const dusaeva::CompositeShape &shape) :
  count_(shape.count_),
  shapesArray_(std::make_unique<dusaeva::Shape::ptr_type[]>(shape.count_))
{
...
dusaeva::CompositeShape::CompositeShape(dusaeva::CompositeShape &&shape) noexcept:
  count_(shape.count_),
  shapesArray_(std::move(shape.shapesArray_))
{}

dusaeva::CompositeShape::CompositeShape(dusaeva::Shape::ptr_type &shape) :
  count_(1),
  shapesArray_(std::make_unique<dusaeva::Shape::ptr_type[]>(1))
{
  if (shape == nullptr)
  {
...
dusaeva::CompositeShape& dusaeva::CompositeShape::operator =(const CompositeShape &rhs)
{
  if (this != &rhs)
  {
    count_ = rhs.count_;
    array_type tempArray(std::make_unique<dusaeva::Shape::ptr_type[]>(rhs.count_));
    for (size_t i = 0; i < count_; i++)
    {
...
dusaeva::CompositeShape& dusaeva::CompositeShape::operator =(CompositeShape &&rhs) noexcept
{
  if (this != &rhs)
  {
    count_ = rhs.count_;
...
dusaeva::Shape::ptr_type dusaeva::CompositeShape::operator [](size_t index) const
{
  if (index >= count_)
  {
...
double dusaeva::CompositeShape::getArea() const
{
  double area = 0.0;
  for (size_t i = 0; i < count_; ++i)
  {
...
dusaeva::rectangle_t dusaeva::CompositeShape::getFrameRect() const
{
  if (count_ == 0)
  {
...
void dusaeva::CompositeShape::move(double dx, double dy)
{
  for (size_t i = 0; i < count_; ++i)
  {
...
void dusaeva::CompositeShape::move(const dusaeva::point_t &center)
{
...
void dusaeva::CompositeShape::printInfo() const
{
  dusaeva::rectangle_t temp_rect = getFrameRect();
...
void dusaeva::CompositeShape::scale(double scale)
{
  if (scale <= 0)
  {
...
void dusaeva::CompositeShape::rotate(double angle)
{
...
void dusaeva::CompositeShape::add(const Shape::ptr_type &shape)
{
  if (shape == nullptr)
  {
  ...
  array_type tempArray(std::make_unique<dusaeva::Shape::ptr_type[]>(count_ + 1));
  for (size_t i = 0; i < count_; ++i)
  {
...
void dusaeva::CompositeShape::remove(size_t index)
{
  array_type tempArray(std::make_unique<dusaeva::Shape::ptr_type[]>(count_ - 1));
...
size_t dusaeva::CompositeShape::getCount() const
{
  return count_;
}

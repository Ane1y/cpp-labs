...
dusaeva::Triangle::Triangle(const point_t &pointA, const point_t &pointB, const point_t &pointC) :
  pointA_(pointA),
  pointB_(pointB),
  pointC_(pointC),
...
double dusaeva::Triangle::getArea() const
{
...
dusaeva::rectangle_t dusaeva::Triangle::getFrameRect() const
{
...
void dusaeva::Triangle::move(double dx, double dy)
{
  center_.x += dx;
  center_.y += dy;
...
void dusaeva::Triangle::move(const point_t &param)
{
...
void dusaeva::Triangle::printInfo() const
{
...
void dusaeva::Triangle::scale(double scale)
{
  if (scale <= 0)
  {
...
void dusaeva::Triangle::rotate(double angle)
{
...
dusaeva::point_t dusaeva::Triangle::getCenter() const
{
  return center_;
}

dusaeva::point_t dusaeva::Triangle::getNewVertex(const point_t &point, double scale) const
{
...
dusaeva::point_t dusaeva::Triangle::rotate(const point_t &point, double angle) const
{
  angle *=  M_PI / 180;

...
dusaeva::Matrix::Matrix():
  rows_(0),
  columns_(0)
{}

dusaeva::Matrix::Matrix(const Matrix &other):
...
dusaeva::Matrix::Matrix(Matrix &&other):
...
dusaeva::Matrix& dusaeva::Matrix::operator =(const Matrix &rhs)
{
  if (&rhs != this)
  {
...
dusaeva::Matrix& dusaeva::Matrix::operator =(Matrix &&rhs)
{
  if (&rhs != this)
  {
    rows_ = rhs.rows_;
...
dusaeva::Shape::array_type dusaeva::Matrix::operator [](size_t layer) const
{
  if (rows_ <= layer)
  {
...
bool dusaeva::Matrix::operator ==(const Matrix & rhs) const
{
...
size_t dusaeva::Matrix::getRows() const
{
  return rows_;
}

size_t dusaeva::Matrix::getColumns() const
{
  return columns_;
}

size_t dusaeva::Matrix::getLayerSize(size_t layer) const
{
  if (layer >= rows_)
  {
    return 0;
...
void dusaeva::Matrix::add(const Shape::ptr_type &newShape, size_t layer)
{
  if (newShape == nullptr)
  {
